...
class RingDataSpec extends FlatSpec with Matchers {
  ...
  "simpleTest3" should "deserialize order " in {
    info("[sbt lib/'testOnly *RingDataSpec -- -z simpleTest3']")

    val originInput = ""
    val lrc = "0xcd36128815ebe0b44d0374649bad2721b8751bef"
    val deserializer: RingDeserializer = new RingDeserializerImpl(lrc)
    val data = deserializer.deserialize(originInput)
    info("owner:" + data.orders.head.owner)
    info("broker:" + data.orders.head.broker)
    info("owner:" + data.orders.last.owner)
    info("broker:" + data.orders.last.broker)
  }
